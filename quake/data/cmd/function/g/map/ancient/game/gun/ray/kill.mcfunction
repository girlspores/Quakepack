...
execute as @a[tag=p1_die,team=ancient] if entity @a[tag=p1_killed,team=ancient] run tellraw @a[team=ancient] [{"color":"aqua","selector":"@p[tag=p1]"},{"color":"gray","text":" gibbed "},{"color":"aqua","selector":"@s[tag=p1_die]"}]
execute as @a[tag=p2_die,team=ancient] if entity @a[tag=p2_killed,team=ancient] run tellraw @a[team=ancient] [{"color":"aqua","selector":"@p[tag=p2]"},{"color":"gray","text":" gibbed "},{"color":"aqua","selector":"@s[tag=p2_die]"}]
execute as @a[tag=p3_die,team=ancient] if entity @a[tag=p3_killed,team=ancient] run tellraw @a[team=ancient] [{"color":"aqua","selector":"@p[tag=p3]"},{"color":"gray","text":" gibbed "},{"color":"aqua","selector":"@s[tag=p3_die]"}]
execute as @a[tag=p4_die,team=ancient] if entity @a[tag=p4_killed,team=ancient] run tellraw @a[team=ancient] [{"color":"aqua","selector":"@p[tag=p4]"},{"color":"gray","text":" gibbed "},{"color":"aqua","selector":"@s[tag=p4_die]"}]
execute as @a[tag=p5_die,team=ancient] if entity @a[tag=p5_killed,team=ancient] run tellraw @a[team=ancient] [{"color":"aqua","selector":"@p[tag=p5]"},{"color":"gray","text":" gibbed "},{"color":"aqua","selector":"@s[tag=p5_die]"}]
execute as @a[tag=p6_die,team=ancient] if entity @a[tag=p6_killed,team=ancient] run tellraw @a[team=ancient] [{"color":"aqua","selector":"@p[tag=p6]"},{"color":"gray","text":" gibbed "},{"color":"aqua","selector":"@s[tag=p6_die]"}]
execute as @a[tag=p7_die,team=ancient] if entity @a[tag=p7_killed,team=ancient] run tellraw @a[team=ancient] [{"color":"aqua","selector":"@p[tag=p7]"},{"color":"gray","text":" gibbed "},{"color":"aqua","selector":"@s[tag=p7_die]"}]
execute as @a[tag=p8_die,team=ancient] if entity @a[tag=p8_killed,team=ancient] run tellraw @a[team=ancient] [{"color":"aqua","selector":"@p[tag=p8]"},{"color":"gray","text":" gibbed "},{"color":"aqua","selector":"@s[tag=p8_die]"}]
execute as @a[tag=p9_die,team=ancient] if entity @a[tag=p9_killed,team=ancient] run tellraw @a[team=ancient] [{"color":"aqua","selector":"@p[tag=p9]"},{"color":"gray","text":" gibbed "},{"color":"aqua","selector":"@s[tag=p9_die]"}]
execute as @a[tag=p10_die,team=ancient] if entity @a[tag=p10_killed,team=ancient] run tellraw @a[team=ancient] [{"color":"aqua","selector":"@p[tag=p10]"},{"color":"gray","text":" gibbed "},{"color":"aqua","selector":"@s[tag=p10_die]"}]
execute as @a[tag=p11_die,team=ancient] if entity @a[tag=p11_killed,team=ancient] run tellraw @a[team=ancient] [{"color":"aqua","selector":"@p[tag=p11]"},{"color":"gray","text":" gibbed "},{"color":"aqua","selector":"@s[tag=p11_die]"}]
execute as @a[tag=p12_die,team=ancient] if entity @a[tag=p12_killed,team=ancient] run tellraw @a[team=ancient] [{"color":"aqua","selector":"@p[tag=p12]"},{"color":"gray","text":" gibbed "},{"color":"aqua","selector":"@s[tag=p12_die]"}]
...
execute as @p[tag=p1_killed,team=ancient] at @s run scoreboard players add @s kills.ancient 1
execute as @p[tag=p2_killed,team=ancient] at @s run scoreboard players add @s kills.ancient 1
execute as @p[tag=p3_killed,team=ancient] at @s run scoreboard players add @s kills.ancient 1
execute as @p[tag=p4_killed,team=ancient] at @s run scoreboard players add @s kills.ancient 1
execute as @p[tag=p5_killed,team=ancient] at @s run scoreboard players add @s kills.ancient 1
execute as @p[tag=p6_killed,team=ancient] at @s run scoreboard players add @s kills.ancient 1
execute as @p[tag=p7_killed,team=ancient] at @s run scoreboard players add @s kills.ancient 1
execute as @p[tag=p8_killed,team=ancient] at @s run scoreboard players add @s kills.ancient 1
execute as @p[tag=p9_killed,team=ancient] at @s run scoreboard players add @s kills.ancient 1
execute as @p[tag=p10_killed,team=ancient] at @s run scoreboard players add @s kills.ancient 1
execute as @p[tag=p11_killed,team=ancient] at @s run scoreboard players add @s kills.ancient 1
execute as @p[tag=p12_killed,team=ancient] at @s run scoreboard players add @s kills.ancient 1
...
execute as @a at @s if score @s kills.ancient matches 25..30 run function cmd:g/map/ancient/game/end
