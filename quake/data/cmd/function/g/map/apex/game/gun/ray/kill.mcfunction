...
execute as @p[tag=p2_killed,team=apex] at @s run scoreboard players add @s kills.Apex 1
execute as @p[tag=p3_killed,team=apex] at @s run scoreboard players add @s kills.Apex 1
execute as @p[tag=p4_killed,team=apex] at @s run scoreboard players add @s kills.Apex 1
execute as @p[tag=p5_killed,team=apex] at @s run scoreboard players add @s kills.Apex 1
execute as @p[tag=p6_killed,team=apex] at @s run scoreboard players add @s kills.Apex 1
execute as @p[tag=p7_killed,team=apex] at @s run scoreboard players add @s kills.Apex 1
execute as @p[tag=p8_killed,team=apex] at @s run scoreboard players add @s kills.Apex 1
execute as @p[tag=p9_killed,team=apex] at @s run scoreboard players add @s kills.Apex 1
execute as @p[tag=p10_killed,team=apex] at @s run scoreboard players add @s kills.Apex 1
execute as @p[tag=p11_killed,team=apex] at @s run scoreboard players add @s kills.Apex 1
execute as @p[tag=p12_killed,team=apex] at @s run scoreboard players add @s kills.Apex 1
...
execute as @a at @s if score @s kills.Apex matches 25..30 run function cmd:g/map/apex/game/end
