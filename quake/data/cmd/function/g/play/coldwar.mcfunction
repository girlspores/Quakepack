...
team leave @s
team join coldwar @s
tellraw @a[team=] [{"color":"yellow","selector":"@s"},{"color":"yellow","text":" joined "},{"bold":true,"color":"green","text":"Cold War"},{"bold":false,"color":"green","text":"."}]
tellraw @a[team=coldwar] [{"color":"yellow","selector":"@s"},{"color":"yellow","text":" joined "},{"bold":true,"color":"green","text":"Cold War"},{"bold":false,"color":"green","text":"."}]
execute as @s at @e[type=marker,tag=coldwar,tag=0] run tp @s ~ ~ ~ -90 0
effect give @s speed infinite 1 true

#start timer
execute unless entity @p[tag=p1] run schedule function cmd:g/map/coldwar/game/start 5t
#player index
