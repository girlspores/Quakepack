...
team leave @s
team join apex3 @s
tellraw @a[team=] [{"color":"yellow","selector":"@s"},{"color":"yellow","text":" joined "},{"bold":true,"color":"green","text":"Apex III"},{"bold":false,"color":"green","text":"."}]
tellraw @a[team=apex3] [{"color":"yellow","selector":"@s"},{"color":"yellow","text":" joined "},{"bold":true,"color":"green","text":"Apex III"},{"bold":false,"color":"green","text":"."}]
execute as @s at @e[type=marker,tag=apex3,tag=0] run tp @s ~ ~ ~ -90 0
effect give @s speed infinite 1 true

#start timer
execute unless entity @p[tag=p1] run schedule function cmd:g/map/apex3/game/start 5t
#player index
